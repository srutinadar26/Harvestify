...
const Navbar = () => {
  ...
  { name: t('AI Assistant'), path: '/chatbot', icon: <FaRobot /> }, // ← Add this
  ...(currentUser ? [{ name: t('Dashboard'), path: '/dashboard' }] : []),
];
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            {!currentUser ? (
              ...
              <Link
                to="/dashboard"
                className="px-5 py-2 rounded-lg bg-primary text-white font-medium hover:bg-green-700 transition-all duration-300 shadow-md hover:shadow-lg"
              >
                {t('Dashboard')}
              </Link>
            )}
